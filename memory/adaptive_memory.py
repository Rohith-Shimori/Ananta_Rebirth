...
class AdaptiveMemory:
    ...
    def _init_database(self):
        ...
        # ⚡ Bolt: Open persistent connection with check_same_thread=False
        # to improve performance by reusing connection across calls.
        self.conn = sqlite3.connect(self.db_path, check_same_thread=False)
        self.conn.row_factory = sqlite3.Row  # Optional: nicer row access
