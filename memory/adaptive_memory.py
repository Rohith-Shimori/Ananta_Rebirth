...
class AdaptiveMemory:
    ...
    - Uses a persistent SQLite connection with threading.RLock for thread safety.
    - Enables WAL (Write-Ahead Logging) mode for better concurrency.
    - Sets synchronous=NORMAL for faster writes while maintaining safety.
    - Benchmarked: ~23x faster than opening/closing connections per operation (0.54s -> 0.02s for 100 ops).
    """
